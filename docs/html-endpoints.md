...
|---|---|---|---|---|
| 1 | `backend/captive-portal-lentium/portal.html` | `http://192.168.1.167/`, `http://192.168.1.167/portal`, `http://captive.local/portal` | Portal Lentium | Página principal de registro (cliente/invitado). Llama a `/api/register/client` y `/api/register/guest` (alias `/api/register/quest`). |
...
|---|---|---|---|
| 7 | `http://192.168.1.167/people` (también `http://people.local/people`) | Portal Lentium | Dashboard de personas registradas y estado de conectividad (usa `/api/people/dashboard`). |
